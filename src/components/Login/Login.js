...
export const Login = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    password: Yup.string()
      .min(5, "Password must contain atleast 5 character")
    ...
    <div className="loginContainer">
      ...
      <div className="loginAndCreateAccountDivision">
        <div className="createAnAccount">
          <div className="newCustomerHeader">New Customers</div>
          <div className="subTextInCreateAnAccount">
