...
export const Register = () => {
  ...
  const validationSchema = Yup.object().shape({
    firstname: Yup.string()
      .min(3, "Firstname should atleast contain 3 characters")
      .required("Please fill First name"),
    lastname: Yup.string()
      .min(3, "Lastname should atleast contain 3 characters")
      .required("Please fill Last name"),
    email: Yup.string()
      .email("Please enter a valid email")
      .required("Please fill Email address"),
    password: Yup.string()
      .min(5, "Password must contain 5 character")
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Please enter the following Information to create account
                  </span>
                </div>
              </div>
              <div
